...
import { getVaultConfig, upsertPolicy } from "../../../../lib/clients/vault/index.js";

const inputSchema = z.object({
  name: z
    .string()
    .describe("Policy name (must be unique and alphanumeric with dashes/underscores)"),
  policy: z
    .string()
    .describe(
      'Policy document in HCL format defining permissions (e.g., \'path "secret/*" { capabilities = ["read", "list"] }\')'
    ),
});
